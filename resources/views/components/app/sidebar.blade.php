    ...
    <div id="sidebar"
        ...
        <div class="flex justify-between mb-10 pr-3 sm:px-2">
            ...
            <a class="block flex items-center" href="{{ route('dashboard') }}">
                ...
                <!-- Left: Title -->
                <div class="m-0 sm:mb-0">
                    <h1 class="text-2xl md:text-2xl text-gray-800 dark:text-gray-100 font-bold text-center">GRH-ODEJ</h1>
                </div>
            </a>
        </div>
                            ...
                            <ul class="pl-8 mt-1 @if (!in_array(Request::segment(1), ['dashboard'])) {{ 'hidden' }} @endif"
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate @if (Route::is('dashboard')) {{ '!text-violet-500' }} @endif"
                                        href="{{ route('fonctionaires') }}">
                                        <span
                                            class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Gestion
                                            du personnel</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
