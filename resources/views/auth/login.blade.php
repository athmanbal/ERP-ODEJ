<x-authentication-layout>
    <h1 class="text-3xl text-blue-800 dark:text-gray-100 font-bold mb-6" style="text-shadow: 2px 2px 4px rgba(24, 7, 132, 0.5);">
        {{ __('Authentification') }}
    </h1>
    @if (session('status'))
    ...
    <div class="pt-5 mt-6 border-t border-gray-100 dark:border-gray-700/60">
        ...
        <div class="mt-5">
            <div class="bg-yellow-500/20 text-yellow-700 px-3 py-2 rounded-lg">
                ...
                <span class="text-sm">
                      منصة نسخ الملفات الادارية  .
                      <br> athmanbal@gmail.com
                </span>
            </div>
        </div>
    </div>
